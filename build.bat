...
for /d %%i in (.\UnrealEssentials\P3R\Content\L10N\*) do (
    %COMPILER% .\bmd\Xrd777_BMD_FldSupport_AutoRecover.msg -Compile -OutFormat V1RE -Library P3RE -Encoding UTF-8  -Hook -SumBits -UPatch %%i\Xrd777\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BMD_FldSupport_AutoRecover.uasset -Out %%i\Xrd777\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BMD_FldSupport_AutoRecover_new
    ...
    ::Episode Aigis bmd uasset
    %COMPILER% .\bmd\Astrea_BMD_FldSupport_AutoRecover.msg -Compile -OutFormat V1RE -Library P3RE -Encoding UTF-8  -Hook -SumBits -UPatch %%i\Astrea\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BMD_FldSupport_AutoRecover.uasset -Out %%i\Astrea\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BMD_FldSupport_AutoRecover_new
    if exist %%i\Astrea\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BMD_FldSupport_AutoRecover_new.uasset (
        move /y %%i\Astrea\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BMD_FldSupport_AutoRecover_new.uasset %%i\Astrea\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BMD_FldSupport_AutoRecover.uasset
        del /s /q %%i\Astrea\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BMD_FldSupport_AutoRecover_new
    )
)
:: Compile Japanese bmd uassets
%COMPILER% .\bmd\Xrd777_BMD_FldSupport_AutoRecover.msg -Compile -OutFormat V1RE -Library P3RE -Encoding UTF-8  -Hook -SumBits -UPatch .\UnrealEssentials\P3R\Content\Xrd777\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BMD_FldSupport_AutoRecover.uasset -Out .\UnrealEssentials\P3R\Content\Xrd777\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BMD_FldSupport_AutoRecover_new
...
::Episode Aigis Japanaese bmd uasset
%COMPILER% .\bmd\Astrea_BMD_FldSupport_AutoRecover.msg -Compile -OutFormat V1RE -Library P3RE -Encoding UTF-8  -Hook -SumBits -UPatch .\UnrealEssentials\P3R\Content\Astrea\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BMD_FldSupport_AutoRecover.uasset -Out .\UnrealEssentials\P3R\Content\Astrea\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BMD_FldSupport_AutoRecover_new
if exist .\UnrealEssentials\P3R\Content\Astrea\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BMD_FldSupport_AutoRecover_new.uasset (
    move /y .\UnrealEssentials\P3R\Content\Astrea\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BMD_FldSupport_AutoRecover_new.uasset .\UnrealEssentials\P3R\Content\Astrea\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BMD_FldSupport_AutoRecover.uasset
    del /s /q .\UnrealEssentials\P3R\Content\Astrea\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BMD_FldSupport_AutoRecover_new
)
...
::Episode Aigis bf uasset
%COMPILER% .\bf\Astrea_BF_FldSupport_AutoRecover.flow -Compile -OutFormat V4BE -Library P3RE -Encoding UTF-8 -Hook -SumBits -UPatch .\UnrealEssentials\P3R\Content\Astrea\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BF_FldSupport_AutoRecover.uasset -Out .\UnrealEssentials\P3R\Content\Astrea\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BF_FldSupport_AutoRecover_new
if exist .\UnrealEssentials\P3R\Content\Astrea\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BF_FldSupport_AutoRecover_new.uasset (
    move /y .\UnrealEssentials\P3R\Content\Astrea\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BF_FldSupport_AutoRecover_new.uasset .\UnrealEssentials\P3R\Content\Astrea\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BF_FldSupport_AutoRecover.uasset
    del /s /q .\UnrealEssentials\P3R\Content\Astrea\Field\Data\DataAsset\Bf\Dungeon\SupportTalk\BF_FldSupport_AutoRecover_new
)
